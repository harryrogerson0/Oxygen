...
function updateOxygenLevel() {
    ...
    for (var structure in structures) {
        if (structures[structure].src == "Images/Game/tree.png" || structures[structure].src == "Images/Game/apple-tree.png") {
            oxygen += 0.01;
        } else if (structures[structure].src == "Images/Game/sapling.png") {
            oxygen += 0.005;
...
function wind() {
    windArray = [new Sprite(-canvas.width, 0, canvas.width, canvas.height, "Images/Game/wind.png", 5, 0), new Sprite(-(canvas.width * 2), 0, canvas.width, canvas.height, "Images/Game/wind.png", 5, 0)];
    windy = true;
    playSound(windSound);
    ...
    windTimeout = setTimeout(() => {
        ...
        for (var structure in structures) {
            if (windmillImages.includes(structures[structure].src)) {
                if (Math.floor(Math.random() * 5) == 0) {
                    structures[structure].src = "Images/Game/broken-windmill.png"
                }
            }
        }
...
function startGame() {
    ...
    // Updating everything
        ...
        for (var i in windArray) {
            windArray[i].update();

            if (windArray[i].x >= canvas.width) {
                if (windy) {
                    windArray[i].x = -canvas.width;
                } else {
                    windArray.splice(i, 1);
                }
            }
        }
    ...
    canvas.onmousedown = (event) => {
        ...
        for (var structure in structures) {
            if (mouseOverlapsWithArea(getMouseX(event), getMouseY(event), structures[structure].x, structures[structure].y, structures[structure].x + structures[structure].width, structures[structure].y + structures[structure].height)) {
                if (structures[structure].src == "Images/Game/apple-tree.png" && playerInv.includes(null)) {
                ...
                } else if (structures[structure].src == "Images/Game/mound-1.png") {
                    if (playerInv[selectedInvSlot - 1] == "Images/Game/mud.png") {
                        progressBar = new ProgressBar(getMouseX(event) - (progressBarSize / 2), getMouseY(event), 0, 0, () => {
                            playerInv[playerInv.indexOf("Images/Game/mud.png")] = null;
                            structures[structure].src = "Images/Game/mound-2.png";
                            playSound(diggingSound);
                        });
                        return;
                ...
                } else if (structures[structure].src == "Images/Game/mound-2.png") {
                    if (playerInv[selectedInvSlot - 1] == "Images/Game/mud.png") {
                        progressBar = new ProgressBar(getMouseX(event) - (progressBarSize / 2), getMouseY(event), 0, 0, () => {
                            playerInv[playerInv.indexOf("Images/Game/mud.png")] = null;
                            structures[structure].src = "Images/Game/mound-3.png";
                            playSound(diggingSound);
                        });
                        return;
                    } else if (playerInv[selectedInvSlot - 1] == "Images/Game/spade.png") {
                        progressBar = new ProgressBar(getMouseX(event) - (progressBarSize / 2), getMouseY(event), 0, 0, () => {
                            playerInv[playerInv.indexOf("Images/Game/spade.png")] = "Images/Game/mud.png";
                            structures[structure].src = "Images/Game/mound-1.png";
                            playSound(diggingSound);
                        });
                        return;
                    }
                } else if (structures[structure].src == "Images/Game/mound-3.png") {
                    if (playerInv[selectedInvSlot - 1] == "Images/Game/spade.png") {
                        progressBar = new ProgressBar(getMouseX(event) - (progressBarSize / 2), getMouseY(event), 0, 0, () => {
                            playerInv[playerInv.indexOf("Images/Game/spade.png")] = "Images/Game/mud.png";
                            structures[structure].src = "Images/Game/mound-2.png";
                            playSound(diggingSound);
                ...
                } else if (structures[structure].src == "Images/Game/broken-windmill.png") {
                    if (playerInv[selectedInvSlot - 1] == "Images/Game/wood.png") {
                        progressBar = new ProgressBar(getMouseX(event) - (progressBarSize / 2), getMouseY(event), 0, 0, () => {
                            playerInv[playerInv.indexOf("Images/Game/wood.png")] = null;
                            structures[structure].src = "Images/Game/cooldown-windmill-1.png";
                            playSound(buildingSound);
                        ...
                        return;
                    } else if (playerInv[selectedInvSlot - 1] == "Images/Game/sledgehammer.png" && getOccurances(null, playerInv) >= 4) {
                        var buildingCount = 0;
                    ...
                    if (playerInv[selectedInvSlot - 1] == "Images/Game/bucket-water.png") {
                        progressBar = new ProgressBar(getMouseX(event) - (progressBarSize / 2), getMouseY(event), 0, 0, () => {
                            playerInv[playerInv.indexOf("Images/Game/bucket-water.png")] = null;
                            structures[structure].src = "Images/Game/tree.png";
                            playSound(waterSound);
                        ...
                        return;
                    } else if (playerInv[selectedInvSlot - 1] == "Images/Game/axe.png") {
                        progressBar = new ProgressBar(getMouseX(event) - (progressBarSize / 2), getMouseY(event), 0, 0, () => {
                            playerInv[playerInv.indexOf("Images/Game/axe.png")] = "Images/Game/wood.png";
                            structures.splice(structure, 1);
                            playSound(choppingSound);
        ...
        if (mouseOverlapsWithArea(getMouseX(event), getMouseY(event), ground.x + (canvas.width / 2), canvas.height - (groundHeight * 2), ground.x + ground.width - (canvas.width / 2), canvas.height)) {
            if (playerInv[selectedInvSlot - 1] == "Images/Game/apple.png") {
                ...
                progressBar = new ProgressBar(getMouseX(event) - (progressBarSize / 2), getMouseY(event), 0, 0, () => {
                    playerInv[playerInv.indexOf("Images/Game/apple.png")] = null;
                    structures.push(new Sprite(getMouseX(event) - (treeSize / 2), canvas.height - groundHeight - treeSize, treeSize, treeSize, "Images/Game/sapling.png", 0, 0));
                    // oxygen += 0.01;
                    playSound(leavesSound);
                });
                return;
                ...
                return;
            } else if (playerInv[selectedInvSlot - 1] == "Images/Game/mud.png") {
                for (var structure in structures) {
                    if (mouseOverlapsWithArea(getMouseX(event), getMouseY(event), structures[structure].x - (moundSize / 2), structures[structure].y, structures[structure].x + structures[structure].width + (moundSize / 2), canvas.height)) {
                        return;
                    }
                }
                ...
                progressBar = new ProgressBar(getMouseX(event) - (progressBarSize / 2), getMouseY(event), 0, 0, () => {
                    playerInv[playerInv.indexOf("Images/Game/mud.png")] = null;
                    structures.push(new Sprite(getMouseX(event) - (moundSize / 2), canvas.height - groundHeight - moundSize, moundSize, moundSize, "Images/Game/mound-1.png", 0, 0));
                    playSound(diggingSound);
                });
                return;
            }
...
images[69].src = "Images/Game/broken-windmill.png";
images[70].src = "Images/Game/mound-1.png";
images[71].src = "Images/Game/mound-2.png";
images[72].src = "Images/Game/mound-3.png";
images[73].src = "Images/Game/sapling.png";
images[74].src = "Images/Game/wind.png";
